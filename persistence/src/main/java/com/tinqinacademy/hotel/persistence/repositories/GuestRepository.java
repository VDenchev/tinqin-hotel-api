...
public interface GuestRepository extends JpaRepository<Guest, UUID> {
  ...
  @Query("""
           ...
           AND b.id = :bookingId
      """)
  List<Guest> getAllGuestsByBookingIdAndIdCardNumberCollection(UUID bookingId, Collection<String> idCardNumbers);
  ...
  @Query("""
           ...
           WHERE g.idCardNumber IN :idCardNumbers
      """)
  List<Guest> getAllGuestsByIdCardNumberCollection(Collection<String> idCardNumbers);
}
